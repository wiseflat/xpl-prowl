...
var proto = {
	...
	_log: function() {
        ...
        _schema_prowl_basic: function(body) {
                var self = this;
                if(!body.apikey || !body.apikey.match(/^[a-zA-Z0-9]{1,100}$/i) ) return false;
                if(!body.application || !body.application.match(/^[a-zA-Z0-9]{1,100}$/i) ) return false;
        ...
        _schema_prowl_config: function(body) {
                var self = this;
                if(body.enable && !body.enable.match(/^[01]{1}$/i) ) return false;
                return true;
        }
